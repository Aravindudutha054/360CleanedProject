...
function getDefaultLandingPath() {
  ...
  const memberId =
    localStorage.getItem('m360_username') ||
    localStorage.getItem('m360_member_id')
  ...
  return (
    <Routes>
      ...
      <Route path="/" element={<AppLayout />}>
        <Route
          index
          element={<Navigate to={getDefaultLandingPath()} replace />}
        />
        ...
        <Route
          path="members/:memberId/ai-summary"
          element={<AISummary />}
        />
      </Route>
